        ...
        <div className="first_main">
          ...
          <div className="main_tag_container" style={{ transform: `translate(${xTranslation}px, ${yTranslation}px)` }}>
            <div className="tagName">
              ...
              <img className="schedule_image" style={{ height: 232.078, width: 232.078 }} src={tag} alt="tag" />
            </div>
            <div className="tagName">
              <h1 className="h1">Mark Attendance</h1>
              <h2 className="faint_text">Your dashboard gives you access to some more tools to make your work attendance. Like</h2>
              <img className="schedule_image" style={{ height: 278.024, width: 231.687 }} src={books} alt="books" />
            </div>
          </div>
          {!active ? (
            <button className="notactive">Proceed</button>
          ) : (
            <button className="active" onClick={() => handlePageScroll()}>
              Proceed
            </button>
          )}
        </div>
